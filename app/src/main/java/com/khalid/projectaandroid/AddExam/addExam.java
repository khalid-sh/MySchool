package com.khalid.projectaandroid.AddExam;
...
public class addExam extends AppCompatActivity {
    ...
    private void showDateDialog(final TextInputEditText date_in) {
        ...
        new DatePickerDialog(addExam.this, dateSetListener, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
    }
